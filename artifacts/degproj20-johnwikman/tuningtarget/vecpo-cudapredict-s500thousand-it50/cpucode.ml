...
let main =
    ...
    in
    let var83_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var82_vecX)) (( + ) (50) (5))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var82_vecX)) (Array.length (var82_vecX))) (10)) (40000000)) (( * ) (16) (( / ) (( + ) (Array.length (var82_vecX)) (( - ) (1536) (1))) (1536)))) in if (( < ) (( * ) (Array.length (var82_vecX)) (( + ) (50) (5))) (( + ) (( + ) (( * ) (( + ) (Array.length (var82_vecX)) (Array.length (var82_vecX))) (10)) (40000000)) (( * ) (16) (( / ) (( + ) (Array.length (var82_vecX)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun79_plusone) (var82_vecX)) else (gpuhost_fun79_plusone [|1|] [||] (var82_vecX))
    in
    let var84_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var82_vecX)) (( + ) (50) (5))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var82_vecX)) (Array.length (var82_vecX))) (10)) (40000000)) (( * ) (16) (( / ) (( + ) (Array.length (var82_vecX)) (( - ) (1536) (1))) (1536)))) in if (( < ) (( * ) (Array.length (var82_vecX)) (( + ) (50) (5))) (( + ) (( + ) (( * ) (( + ) (Array.length (var82_vecX)) (Array.length (var82_vecX))) (10)) (40000000)) (( * ) (16) (( / ) (( + ) (Array.length (var82_vecX)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun79_plusone) (var82_vecX)) else (gpuhost_fun79_plusone [|1|] [||] (var82_vecX))
    in
