...
let tymatrixf_ = tyseq_ tyfloat_
...
let func_matrixMkf =
  let_ "matrixMkf" (tyarrows_ [tyint_, tyint_, tyfloat_, tymatrixf_]) (
    lam_ "rows" (tyint_) (
      lam_ "cols" (tyint_) (
        lam_ "v" (tyfloat_) (
          makeseq_ (muli_ (var_ "rows") (var_ "cols"))
...
let func_matrixInitf =
  let_ "matrixInitf" (tyarrows_ [tyint_, tyint_, tyarrows_ [tyint_, tyint_, tyfloat_], tymatrixf_]) (
    lam_ "rows" (tyint_) (
      lam_ "cols" (tyint_) (
        lam_ "f" (tyarrows_ [tyint_, tyint_, tyfloat_]) (
          let seqInitFun =
            let_ "seqInitFun" (tyarrows_ [tyint_, tyfloat_]) (
              lam_ "i" (tyint_) (
                bindall_ [
                  let_ "row" (tyint_) (divi_ (var_ "i") (var_ "cols")),
                  let_ "col" (tyint_) (modi_ (var_ "i") (var_ "cols")),
...
let func_matrixGetf =
  let_ "matrixGetf" (tyarrows_ [tyint_, tyint_, tyint_, tyint_, tymatrixf_, tyfloat_]) (
    lam_ "row" (tyint_) (
      lam_ "col" (tyint_) (
        lam_ "m_rows" (tyint_) (
          lam_ "m_cols" (tyint_) (
...
let func_matrix2strf =
  let_ "matrix2strf" (tyarrows_ [tyint_, tyint_, tymatrixf_, tystr_]) (
    lam_ "m_rows" (tyint_) (
      lam_ "m_cols" (tyint_) (
        lam_ "m" (tymatrixf_) (
          let printrc =
...
let func_printMatrixf =
  let_ "printMatrixf" (tyarrows_ [tyint_, tyint_, tymatrixf_, tyunit_]) (
    lam_ "m_rows" (tyint_) (
      lam_ "m_cols" (tyint_) (
        lam_ "m" (tymatrixf_) (
          let printrc =
...
let func_matrixMulfWorker =
  let_ "matrixMulfWorker" (tyarrows_ [tyint_, tyint_, tyint_, tymatrixf_, tymatrixf_, tyint_, tyfloat_]) (
    lam_ "innerDim" (tyint_) (
      lam_ "a_rows" (tyint_) (
        lam_ "b_cols" (tyint_) (
          lam_ "a" (tymatrixf_) (
            lam_ "b" (tymatrixf_) (
              lam_ "idx" (tyint_) (
                bindall_ [
                  ...
                  let_ "a_start_offset" (tyint_) (muli_ (var_ "innerDim") (var_ "row")),
                  let_ "b_start_offset" (tyint_) (var_ "col"),
                  reclets_add "dotprod" (tyarrows_ [tyfloat_, tyint_, tyint_, tyint_, tyfloat_]) (
                    lam_ "acc" (tyfloat_) (
                      lam_ "p" (tyint_) (
                        lam_ "a_offset" (tyint_) (
                          lam_ "b_offset" (tyint_) (
                            if_ (eqi_ (var_ "p") (var_ "innerDim"))
                                ...
                                (app4f_ (var_ "dotprod")
                                        (addf_ (var_ "acc")
                                               (mulf_ (nth_ (var_ "a") (var_ "a_offset"))
                                                      (nth_ (var_ "b") (var_ "b_offset"))))
                                        (addi_ (var_ "p") (int_ 1))
                                        (addi_ (var_ "a_offset") (int_ 1))
                                        (addi_ (var_ "b_offset") (var_ "b_cols")))
...
-- //
-- let matrixATAiWorker = lam rows. lam cols. lam a. lam idx.
...
let func_matrixATAiWorker =
  let_ "matrixATAiWorker" (tyarrows_ [tyint_, tyint_, tymatrixi_, tyint_, tyint_]) (
    lam_ "rows" (tyint_) (
      lam_ "cols" (tyint_) (
        lam_ "a" (tymatrixi_) (
          lam_ "idx" (tyint_) (
...
let func_matrixATAfWorker =
  let_ "matrixATAfWorker" (tyarrows_ [tyint_, tyint_, tymatrixf_, tyint_, tyfloat_]) (
    lam_ "rows" (tyint_) (
      lam_ "cols" (tyint_) (
        lam_ "a" (tymatrixf_) (
          lam_ "idx" (tyint_) (
