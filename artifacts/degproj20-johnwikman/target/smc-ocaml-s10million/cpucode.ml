...
let main =
    ...
    let fun116_seqMaxf arg96_s =
        ...
        in
        let var115_partial  =
            fun14_seqInit (var98_s_initsize) (fun114_initfun (arg96_s) (var97_s_len))
        in
    ...
    let fun133_seqSumf arg117_s =
        ...
        in
        let var132_partial  =
            fun14_seqInit (var119_s_initsize) (fun131_initfun (arg117_s) (var118_s_len))
        in
    ...
    let rec fun209_iterate_smc arg239_obs arg224_heightMap arg222_heightMapSize arg220_nPoints arg218_altitude arg216_velocity arg214_sigma arg210_i arg211_steps arg212_x arg213_w =
            if ( = ) (arg210_i) (arg211_steps) then
                ...
                let var237_x_propagated  =
                    fun14_seqInit (var221_nPoints) (fun236_propagate_x (var215_sigma) (var217_velocity) (arg212_x) (var221_nPoints) (var226_wacc))
                in
                let var238_log_1onN  =
                ...
                in
                let var249_w  =
                    fun8_map (fun248_wmapf (var238_log_1onN) (var215_sigma) (var223_heightMapSize) (var225_heightMap) (var219_altitude) (var240_ithobs)) (var237_x_propagated)
                in
                let var250_wmax  =
                    fun116_seqMaxf (var249_w)
                in
                let var254_w  =
                    fun8_map (fun253_wmapf (var250_wmax)) (var249_w)
                in
                let var255_wsum  =
                    fun133_seqSumf (var254_w)
                in
                let var259_w_updated  =
                    fun8_map (fun258_wmapf (var255_wsum)) (var254_w)
                in
    ...
    let fun263_bm_runonce arg260_flight_range arg189_obs arg182_heightMap arg180_heightMapSize arg178_nPoints arg176_altitude arg174_velocity arg172_sigma arg170_xUpperBound arg168_xLowerBound arg166__ =
        ...
        in
        let var188_x  =
            fun14_seqInit (var179_nPoints) (fun187_rndinitf (var171_xUpperBound) (var169_xLowerBound))
        in
        let var190_fstobs  =
            Array.get (arg189_obs) (0)
        in
        let var198_w  =
            fun8_map (fun197_wmapf (var173_sigma) (var181_heightMapSize) (var183_heightMap) (var177_altitude) (var190_fstobs)) (var188_x)
        in
        let var199_wmax  =
            fun116_seqMaxf (var198_w)
        in
        let var203_w  =
            fun8_map (fun202_wmapf (var199_wmax)) (var198_w)
        in
        let var204_wsum  =
            fun133_seqSumf (var203_w)
        in
        let var208_w  =
            fun8_map (fun207_wmapf (var204_wsum)) (var203_w)
        in
        let var261_x_res  =
