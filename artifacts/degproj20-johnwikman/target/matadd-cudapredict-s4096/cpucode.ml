...
external gpuhost_fun172_matrixAddfWorker: int array -> float array -> float array -> float array -> float array = "gpuhost_fun172_matrixAddfWorker"
...
let main =
    ...
    let fun183_bm_runonce arg180_matB arg179_matA arg178_mat_cols arg177_mat_rows arg175__ =
        ...
        let var181_matAplusB  =
            if (( < ) (( * ) (( * ) (arg177_mat_rows) (arg178_mat_cols)) (( + ) (50) (32))) (( + ) (( + ) (( * ) (( + ) (( + ) (( * ) (arg177_mat_rows) (arg178_mat_cols)) (Array.length (arg179_matA))) (Array.length (arg180_matB))) (10)) (40000000)) (( * ) (632) (( / ) (( + ) (( * ) (arg177_mat_rows) (arg178_mat_cols)) (( - ) (1536) (1))) (1536))))) then (Array.init (( * ) (arg177_mat_rows) (arg178_mat_cols)) (fun172_matrixAddfWorker (arg179_matA) (arg180_matB))) else (gpuhost_fun172_matrixAddfWorker [|1; ( * ) (arg177_mat_rows) (arg178_mat_cols)|] [||] (arg179_matA) (arg180_matB))
        in
        let var182_bm_t_end  =
            Unix.gettimeofday (())
        in
