...
let main =
    ...
    in
    let var175_matATA  =
        fun14_seqInit (( * ) (var162_matA_cols) (var162_matA_cols)) (fun160_matrixATAfWorker (var161_matA_rows) (var162_matA_cols) (var171_matA))
    in
    let var176_vecATAx  =
        fun14_seqInit (( * ) (var162_matA_cols) (var173_vecX_cols)) (fun141_matrixMulfWorker (var162_matA_cols) (var162_matA_cols) (var173_vecX_cols) (var175_matATA) (var174_vecX))
    in
    ()