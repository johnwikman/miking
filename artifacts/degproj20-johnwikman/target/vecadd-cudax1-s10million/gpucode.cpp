...
extern "C" {
	value gpuhost_fun81_vecaddf(value packedInts, value packedFloats, value arg0, value arg1);
}

__device__ double gpudevice_fun81_vecaddf(value *arg78_x, value *arg79_y, int arg80_i);
__device__ inline double gpu_addf(double x, double y);

__device__ double gpudevice_fun81_vecaddf(value *arg78_x, value *arg79_y, int arg80_i)
{
	return gpu_addf((((double *) arg78_x)[arg80_i]), (((double *) arg79_y)[arg80_i]));
}

__device__ inline double gpu_addf(double x, double y) {return x + y;}

__global__ void gpuglobal_fun81_vecaddf(value *cuda_arg0, value *cuda_arg1, value *outarr, int n, int elemPerThread)
{
	int i;
	...
	for (i = start; i < end; ++i) {
		((double *) outarr)[i] = gpudevice_fun81_vecaddf(cuda_arg0, cuda_arg1, i);
	}
}
...
value gpuhost_fun81_vecaddf(value packedInts, value packedFloats, value arg0, value arg1)
{
	...
	gpuglobal_fun81_vecaddf<<<blockCount,threadsPerBlock>>>(cuda_arg0, cuda_arg1, cuda_outarr, n, elemPerThread);
