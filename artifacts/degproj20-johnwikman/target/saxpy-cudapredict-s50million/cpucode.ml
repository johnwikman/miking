...
let main =
    ...
    let fun97_bm_runonce arg94_vecX arg93_vecY arg92_scalarA arg90__ =
        ...
        in
        let var95_vecS  =
            if (( < ) (( * ) (Array.length (arg94_vecX)) (( + ) (50) (27))) (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (arg94_vecX)) (Array.length (arg93_vecY))) (Array.length (arg94_vecX))) (10)) (40000000)) (( * ) (360) (( / ) (( + ) (Array.length (arg94_vecX)) (( - ) (1536) (1))) (1536))))) then (Array.mapi (fun82_saxpy (arg92_scalarA) (arg93_vecY)) (arg94_vecX)) else (gpuhost_fun82_saxpy [|1|] [|arg92_scalarA|] (arg93_vecY) (arg94_vecX))
        in
        let var96_bm_t_end  =
            Unix.gettimeofday (())
        in
