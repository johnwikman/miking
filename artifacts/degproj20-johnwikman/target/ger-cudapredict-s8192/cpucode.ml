...
external gpuhost_fun173_gerWorkerf: int array -> float array -> float array -> float array -> float array -> float array = "gpuhost_fun173_gerWorkerf"
...
let main =
    ...
    let fun199_bm_runonce arg196_matA arg195_vecY arg194_vecX arg193_matA_cols arg192_matA_rows arg190__ =
        ...
        in
        let var197_matxyA  =
            if (( < ) (( * ) (Array.length (arg196_matA)) (( + ) (50) (58))) (( + ) (( + ) (( * ) (( + ) (( + ) (( + ) (Array.length (arg196_matA)) (Array.length (arg194_vecX))) (Array.length (arg195_vecY))) (Array.length (arg196_matA))) (10)) (40000000)) (( * ) (795) (( / ) (( + ) (Array.length (arg196_matA)) (( - ) (1536) (1))) (1536))))) then (Array.mapi (fun173_gerWorkerf (arg192_matA_rows) (arg193_matA_cols) (arg194_vecX) (arg195_vecY)) (arg196_matA)) else (gpuhost_fun173_gerWorkerf [|1; arg192_matA_rows; arg193_matA_cols|] [||] (arg194_vecX) (arg195_vecY) (arg196_matA))
        in
        let var198_bm_t_end  =
            Unix.gettimeofday (())
        in
