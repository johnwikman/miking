...
let main =
    ...
    let rec fun209_iterate_smc arg239_obs arg224_heightMap arg222_heightMapSize arg220_nPoints arg218_altitude arg216_velocity arg214_sigma arg210_i arg211_steps arg212_x arg213_w =
            if ( = ) (arg210_i) (arg211_steps) then
                ...
                let var237_x_propagated  =
                    if (( < ) (( * ) (var221_nPoints) (( + ) (50) (( + ) (12) (( + ) (0) (( + ) (22) (( + ) (37) (( + ) (10) (( + ) (0) (( * ) (82) (if ( < ) (if ( < ) (1) (( - ) (var221_nPoints) (1)) then
                        ( - ) (var221_nPoints) (1)
                    else
                        ...
                        if ( < ) (1) (( - ) (var221_nPoints) (1)) then
                            ( - ) (var221_nPoints) (1)
                        else
                            1)))))))))) (( + ) (( + ) (( * ) (( + ) (( + ) (var221_nPoints) (Array.length (arg212_x))) (Array.length (var226_wacc))) (10)) (40000000)) (( * ) (( + ) (12) (( + ) (0) (( + ) (102) (( + ) (427) (( + ) (21) (( + ) (0) (( * ) (784) (if ( < ) (if ( < ) (1) (( - ) (var221_nPoints) (1)) then
                        ( - ) (var221_nPoints) (1)
                    else
                        1) ((fun x -> int_of_float (Float.floor x)) ((fun x y -> x +. (Random.float (Float.abs (x -. y)))) (0.0) (1.0e-0))) then
                        (fun x -> int_of_float (Float.floor x)) ((fun x y -> x +. (Random.float (Float.abs (x -. y)))) (0.0) (1.0e-0))
                        ...
                        if ( < ) (1) (( - ) (var221_nPoints) (1)) then
                            ...
                            1)))))))) (( / ) (( + ) (var221_nPoints) (( - ) (1536) (1))) (1536))))) then (Array.init (var221_nPoints) (fun236_propagate_x (var215_sigma) (var217_velocity) (arg212_x) (var221_nPoints) (var226_wacc))) else (gpuhost_fun236_propagate_x [|1; var221_nPoints; var221_nPoints|] [|var215_sigma; var217_velocity|] (arg212_x) (var226_wacc))
                in
                let var238_log_1onN  =
                ...
                in
                let var249_w  =
                    if (( < ) (( * ) (Array.length (var237_x_propagated)) (( + ) (50) (152))) (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var237_x_propagated)) (Array.length (var225_heightMap))) (Array.length (var237_x_propagated))) (10)) (40000000)) (( * ) (1554) (( / ) (( + ) (Array.length (var237_x_propagated)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun248_wmapf (var238_log_1onN) (var215_sigma) (var223_heightMapSize) (var225_heightMap) (var219_altitude) (var240_ithobs)) (var237_x_propagated)) else (gpuhost_fun248_wmapf [|1; var223_heightMapSize|] [|var238_log_1onN; var215_sigma; var219_altitude; var240_ithobs|] (var225_heightMap) (var237_x_propagated))
                in
                let var250_wmax  =
                    fun116_seqMaxf (var249_w)
                in
                let var254_w  =
                    if (( < ) (( * ) (Array.length (var249_w)) (( + ) (50) (28))) (( + ) (( + ) (( * ) (( + ) (Array.length (var249_w)) (Array.length (var249_w))) (10)) (40000000)) (( * ) (228) (( / ) (( + ) (Array.length (var249_w)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun253_wmapf (var250_wmax)) (var249_w)) else (gpuhost_fun253_wmapf [|1|] [|var250_wmax|] (var249_w))
                in
                let var255_wsum  =
                    fun133_seqSumf (var254_w)
                in
                let var259_w_updated  =
                    if (( < ) (( * ) (Array.length (var254_w)) (( + ) (50) (11))) (( + ) (( + ) (( * ) (( + ) (Array.length (var254_w)) (Array.length (var254_w))) (10)) (40000000)) (( * ) (98) (( / ) (( + ) (Array.length (var254_w)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun258_wmapf (var255_wsum)) (var254_w)) else (gpuhost_fun258_wmapf [|1|] [|var255_wsum|] (var254_w))
                in
    ...
    let fun263_bm_runonce arg260_flight_range arg189_obs arg182_heightMap arg180_heightMapSize arg178_nPoints arg176_altitude arg174_velocity arg172_sigma arg170_xUpperBound arg168_xLowerBound arg166__ =
        ...
        in
        let var188_x  =
            if (( < ) (( * ) (var179_nPoints) (( + ) (50) (28))) (( + ) (( + ) (( * ) (var179_nPoints) (10)) (40000000)) (( * ) (108) (( / ) (( + ) (var179_nPoints) (( - ) (1536) (1))) (1536))))) then (Array.init (var179_nPoints) (fun187_rndinitf (var171_xUpperBound) (var169_xLowerBound))) else (gpuhost_fun187_rndinitf [|1; var179_nPoints|] [|var171_xUpperBound; var169_xLowerBound|] )
        in
        let var190_fstobs  =
            Array.get (arg189_obs) (0)
        in
        let var198_w  =
            if (( < ) (( * ) (Array.length (var188_x)) (( + ) (50) (147))) (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var188_x)) (Array.length (var183_heightMap))) (Array.length (var188_x))) (10)) (40000000)) (( * ) (1529) (( / ) (( + ) (Array.length (var188_x)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun197_wmapf (var173_sigma) (var181_heightMapSize) (var183_heightMap) (var177_altitude) (var190_fstobs)) (var188_x)) else (gpuhost_fun197_wmapf [|1; var181_heightMapSize|] [|var173_sigma; var177_altitude; var190_fstobs|] (var183_heightMap) (var188_x))
        in
        let var199_wmax  =
            fun116_seqMaxf (var198_w)
        in
        let var203_w  =
            if (( < ) (( * ) (Array.length (var198_w)) (( + ) (50) (28))) (( + ) (( + ) (( * ) (( + ) (Array.length (var198_w)) (Array.length (var198_w))) (10)) (40000000)) (( * ) (228) (( / ) (( + ) (Array.length (var198_w)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun202_wmapf (var199_wmax)) (var198_w)) else (gpuhost_fun202_wmapf [|1|] [|var199_wmax|] (var198_w))
        in
        let var204_wsum  =
            fun133_seqSumf (var203_w)
        in
        let var208_w  =
            if (( < ) (( * ) (Array.length (var203_w)) (( + ) (50) (11))) (( + ) (( + ) (( * ) (( + ) (Array.length (var203_w)) (Array.length (var203_w))) (10)) (40000000)) (( * ) (98) (( / ) (( + ) (Array.length (var203_w)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun207_wmapf (var204_wsum)) (var203_w)) else (gpuhost_fun207_wmapf [|1|] [|var204_wsum|] (var203_w))
        in
        let var261_x_res  =
