...
let main =
    ...
    let fun94_bm_runonce arg91_vecX arg90_scalarY arg89_scalarA arg87__ =
        ...
        in
        let var92_vecS  =
            if (( < ) (( * ) (Array.length (arg91_vecX)) (( + ) (50) (16))) (( + ) (( + ) (( * ) (( + ) (Array.length (arg91_vecX)) (Array.length (arg91_vecX))) (10)) (40000000)) (( * ) (59) (( / ) (( + ) (Array.length (arg91_vecX)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun81_saxpy (arg89_scalarA) (arg90_scalarY)) (arg91_vecX)) else (gpuhost_fun81_saxpy [|1|] [|arg89_scalarA; arg90_scalarY|] (arg91_vecX))
        in
        let var93_bm_t_end  =
            Unix.gettimeofday (())
        in
    ...
    let var224__  =
        ...
        in
        let var179__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var168_median))
        in
        let var180__  =
        ...
        in
        let var182__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var171_max))
        in
        let var183__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var185__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var172_min))
        in
        let var186__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var188__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var170_avg))
        in
        let var189__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var191__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var173_variance))
        in
        let var192__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        let var193_median  =
            fun128_bm_median (var159_bmres_warmup)
        in
        let var194_sum  =
            fun136_bm_sum (var159_bmres_warmup)
        in
        let var195_avg  =
            ( /. ) (var194_sum) (4.0e+0)
        in
        let var196_max  =
            fun145_bm_max (var159_bmres_warmup)
        in
        let var197_min  =
            fun154_bm_min (var159_bmres_warmup)
        in
        let var198_variance  =
            fun145_bm_max ([|fun157_bm_dist (var195_avg) (var196_max); fun157_bm_dist (var195_avg) (var197_min)|])
        in
        let var199_median  =
            ( *. ) (var193_median) (1.0e+3)
        in
        let var200_sum  =
            ( *. ) (var194_sum) (1.0e+3)
        in
        ...
        in
        let var210__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var199_median))
        in
        let var211__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var213__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var202_max))
        in
        let var214__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var216__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var203_min))
        in
        let var217__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var219__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var201_avg))
        in
        let var220__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
        ...
        in
        let var222__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) (fun21_float2string (var204_variance))
        in
        let var223__  =
            (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|' '; 'm'; 's'; '\n'|])
        in
