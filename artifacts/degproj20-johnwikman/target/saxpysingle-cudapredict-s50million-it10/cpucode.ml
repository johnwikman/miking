...
let main =
    ...
    in
    let var87_vecS  =
        if (( < ) (( * ) (Array.length (var85_vecX)) (( + ) (50) (16))) (( + ) (( + ) (( * ) (( + ) (Array.length (var85_vecX)) (Array.length (var85_vecX))) (10)) (40000000)) (( * ) (59) (( / ) (( + ) (Array.length (var85_vecX)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun81_saxpy (var84_scalarA) (var86_scalarY)) (var85_vecX)) else (gpuhost_fun81_saxpy [|1|] [|var84_scalarA; var86_scalarY|] (var85_vecX))
    in
    let var88_vecS  =
        if (( < ) (( * ) (Array.length (var85_vecX)) (( + ) (50) (16))) (( + ) (( + ) (( * ) (( + ) (Array.length (var85_vecX)) (Array.length (var85_vecX))) (10)) (40000000)) (( * ) (59) (( / ) (( + ) (Array.length (var85_vecX)) (( - ) (1536) (1))) (1536))))) then (Array.map (fun81_saxpy (var84_scalarA) (var86_scalarY)) (var85_vecX)) else (gpuhost_fun81_saxpy [|1|] [|var84_scalarA; var86_scalarY|] (var85_vecX))
    in
