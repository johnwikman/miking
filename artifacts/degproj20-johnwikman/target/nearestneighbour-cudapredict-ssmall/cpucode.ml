...
external gpuhost_fun85_nnDistance: int array -> float array -> float array -> float array -> float array = "gpuhost_fun85_nnDistance"
...
let main =
    ...
    let fun103_bm_runonce arg100_pointsY arg99_pointsX arg98_pY arg97_pX arg96_numPoints arg94__ =
        ...
        let var101_distances  =
            if (( < ) (( * ) (arg96_numPoints) (( + ) (50) (76))) (( + ) (( + ) (( * ) (( + ) (( + ) (arg96_numPoints) (Array.length (arg99_pointsX))) (Array.length (arg100_pointsY))) (10)) (40000000)) (( * ) (942) (( / ) (( + ) (arg96_numPoints) (( - ) (1536) (1))) (1536))))) then (Array.init (arg96_numPoints) (fun85_nnDistance (arg97_pX) (arg98_pY) (arg99_pointsX) (arg100_pointsY))) else (gpuhost_fun85_nnDistance [|1; arg96_numPoints|] [|arg97_pX; arg98_pY|] (arg99_pointsX) (arg100_pointsY))
        in
        let var102_bm_t_end  =
            Unix.gettimeofday (())
        in
