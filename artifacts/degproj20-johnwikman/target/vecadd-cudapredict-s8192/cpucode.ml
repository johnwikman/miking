...
let main =
    ...
    let fun95_bm_runonce arg92_vecY arg91_vecX arg90_vecsize arg88__ =
        ...
        in
        let var93_vecS  =
            if (( < ) (( * ) (arg90_vecsize) (( + ) (50) (32))) (( + ) (( + ) (( * ) (( + ) (( + ) (arg90_vecsize) (Array.length (arg91_vecX))) (Array.length (arg92_vecY))) (10)) (40000000)) (( * ) (632) (( / ) (( + ) (arg90_vecsize) (( - ) (1536) (1))) (1536))))) then (Array.init (arg90_vecsize) (fun81_vecaddf (arg91_vecX) (arg92_vecY))) else (gpuhost_fun81_vecaddf [|1; arg90_vecsize|] [||] (arg91_vecX) (arg92_vecY))
        in
        let var94_bm_t_end  =
            Unix.gettimeofday (())
        in
