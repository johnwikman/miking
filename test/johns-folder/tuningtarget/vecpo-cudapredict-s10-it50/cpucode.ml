...
let main =
    ...
    in
    let var73_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var72_vecX)) (9)) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (2)) (150000000)) (( * ) (26) (( / ) (Array.length (var72_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var72_vecX)) (9)) (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (2)) (150000000)) (( * ) (26) (( / ) (Array.length (var72_vecX)) (1024))))) then (Array.map (fun69_plusone) (var72_vecX)) else (gpuhost_fun69_plusone [|1|] [||] (var72_vecX))
    in
    let var74_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var72_vecX)) (9)) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (2)) (150000000)) (( * ) (26) (( / ) (Array.length (var72_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var72_vecX)) (9)) (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (2)) (150000000)) (( * ) (26) (( / ) (Array.length (var72_vecX)) (1024))))) then (Array.map (fun69_plusone) (var72_vecX)) else (gpuhost_fun69_plusone [|1|] [||] (var72_vecX))
    in
    ...
    in
    let var124__  =
        fun66_printVec (var67_vecsize) (var72_vecX)
    in
    let var125__  =
        (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|'\n'; 'v'; 'e'; 'c'; 'S'; ':'; '\n'|])
    in
    let var126__  =
        fun66_printVec (var67_vecsize) (var122_vecS)
    in
    ()