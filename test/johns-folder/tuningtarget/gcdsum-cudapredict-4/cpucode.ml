...
external gpuhost_fun70_gcdsum: int array -> float array -> int array -> int array -> int array = "gpuhost_fun70_gcdsum"
...
let main =
    ...
    in
    let var87_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var75_vecX)) (( + ) (6) (( + ) (0) (( + ) (10) (( + ) (0) (( * ) (( * ) (1) (if ( < ) (if ( < ) (1) (var57_vecsize) then
            var57_vecsize
        else
            1) (Array.get (var76_vecY) (0)) then
            Array.get (var76_vecY) (0)
        else
            if ( < ) (1) (var57_vecsize) then
                var57_vecsize
            else
                1)) (( + ) (12) (if ( < ) (1) (( + ) (15) (( + ) (10) (( + ) (5) (( + ) (1) (( + ) (10) (( + ) (0) (( * ) (34) (if ( < ) (1) (Array.get (var76_vecY) (0)) then
            Array.get (var76_vecY) (0)
        else
            1)))))))) then
            ( + ) (15) (( + ) (10) (( + ) (5) (( + ) (1) (( + ) (10) (( + ) (0) (( * ) (34) (if ( < ) (1) (Array.get (var76_vecY) (0)) then
                Array.get (var76_vecY) (0)
            else
                1)))))))
        else
            1)))))))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var75_vecX)) (Array.length (var76_vecY))) (Array.length (var75_vecX))) (2)) (150000000)) (( * ) (( + ) (6) (( + ) (0) (( + ) (10) (( + ) (0) (( * ) (( * ) (1) (if ( < ) (if ( < ) (1) (var57_vecsize) then
            var57_vecsize
        else
            1) (Array.get (var76_vecY) (0)) then
            Array.get (var76_vecY) (0)
            ...
            if ( < ) (1) (var57_vecsize) then
                ...
                1)) (( + ) (324) (if ( < ) (1) (( + ) (70005) (( + ) (27) (( + ) (22) (( + ) (1) (( + ) (205) (( + ) (0) (( * ) (70357) (if ( < ) (1) (Array.get (var76_vecY) (0)) then
            Array.get (var76_vecY) (0)
        else
            1)))))))) then
            ( + ) (70005) (( + ) (27) (( + ) (22) (( + ) (1) (( + ) (205) (( + ) (0) (( * ) (70357) (if ( < ) (1) (Array.get (var76_vecY) (0)) then
                Array.get (var76_vecY) (0)
            else
                1)))))))
        else
            1))))))) (( / ) (Array.length (var75_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var75_vecX)) (( + ) (6) (( + ) (0) (( + ) (10) (( + ) (0) (( * ) (( * ) (1) (if ( < ) (if ( < ) (1) (var57_vecsize) then
            var57_vecsize
        else
            1) (Array.get (var76_vecY) (0)) then
            Array.get (var76_vecY) (0)
            ...
            1)))))))) (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var75_vecX)) (Array.length (var76_vecY))) (Array.length (var75_vecX))) (2)) (150000000)) (( * ) (( + ) (6) (( + ) (0) (( + ) (10) (( + ) (0) (( * ) (( * ) (1) (if ( < ) (if ( < ) (1) (var57_vecsize) then
            var57_vecsize
        else
            1) (Array.get (var76_vecY) (0)) then
            Array.get (var76_vecY) (0)
            ...
            1))))))) (( / ) (Array.length (var75_vecX)) (1024))))) then (Array.map (fun70_gcdsum (var76_vecY) (var57_vecsize)) (var75_vecX)) else (gpuhost_fun70_gcdsum [|1; var57_vecsize|] [||] (var76_vecY) (var75_vecX))
    in
    let var88__  =
        (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|'\n'; 'v'; 'e'; 'c'; 'X'; ':'; '\n'|])
    in
