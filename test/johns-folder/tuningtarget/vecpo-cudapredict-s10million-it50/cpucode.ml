...
let main =
    ...
    in
    let var73_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var72_vecX)) (( + ) (24) (5))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (3)) (30000000)) (( * ) (34) (( / ) (Array.length (var72_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var72_vecX)) (( + ) (24) (5))) (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (3)) (30000000)) (( * ) (34) (( / ) (Array.length (var72_vecX)) (1024))))) then (Array.map (fun69_plusone) (var72_vecX)) else (gpuhost_fun69_plusone [|1|] [||] (var72_vecX))
    in
    let var74_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var72_vecX)) (( + ) (24) (5))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (3)) (30000000)) (( * ) (34) (( / ) (Array.length (var72_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var72_vecX)) (( + ) (24) (5))) (( + ) (( + ) (( * ) (( + ) (Array.length (var72_vecX)) (Array.length (var72_vecX))) (3)) (30000000)) (( * ) (34) (( / ) (Array.length (var72_vecX)) (1024))))) then (Array.map (fun69_plusone) (var72_vecX)) else (gpuhost_fun69_plusone [|1|] [||] (var72_vecX))
    in
