...
let main =
    ...
    in
    let var165_matATA  =
        fun14_seqInit (( * ) (var152_matA_cols) (var152_matA_cols)) (fun150_matrixATAWorker (var151_matA_rows) (var152_matA_cols) (var161_matA))
    in
    let var166_vecATAx  =
        fun14_seqInit (( * ) (var152_matA_cols) (var163_vecX_cols)) (fun131_matrixMuliWorker (var152_matA_cols) (var152_matA_cols) (var163_vecX_cols) (var165_matATA) (var164_vecX))
    in
    ()