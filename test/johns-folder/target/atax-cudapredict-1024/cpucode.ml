...
external gpuhost_fun140_matrixATAWorker: int array -> float array -> int array -> int array = "gpuhost_fun140_matrixATAWorker"
...
let main =
    ...
    in
    let fun150_vecXinitfun arg148_row arg149_col =
        ( mod ) (( * ) (arg148_row) (10657)) (41081)
    in
    ...
    let var142_matA_cols  =
        1024
    in
    let var143_matB_rows  =
        1024
    in
    let var144_matB_cols  =
        1024
    in
    let var151_matA  =
        fun76_matrixIniti (var141_matA_rows) (var142_matA_cols) (fun147_matAinitfun_v2)
    in
    let var152_vecX_rows  =
        var142_matA_cols
    in
    let var153_vecX_cols  =
        1
    in
    let var154_vecX  =
        fun76_matrixIniti (var152_vecX_rows) (var153_vecX_cols) (fun150_vecXinitfun)
    in
    let var155_matATA  =
        let _ = printf "ocamlcost: %d\n" (( * ) (( * ) (var142_matA_cols) (var142_matA_cols)) (( + ) (8) (( + ) (0) (( + ) (1) (( + ) (1) (( + ) (9) (( + ) (9) (( + ) (1) (( + ) (1) (( + ) (14) (( + ) (0) (( * ) (80) (if ( < ) (1) (var141_matA_rows) then
            var141_matA_rows
        else
            1))))))))))))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (( * ) (var142_matA_cols) (var142_matA_cols)) (Array.length (var151_matA))) (2)) (150000000)) (( * ) (( + ) (8) (( + ) (0) (( + ) (1) (( + ) (1) (( + ) (30) (( + ) (30) (( + ) (1) (( + ) (1) (( + ) (14) (( + ) (0) (( * ) (70861) (if ( < ) (1) (var141_matA_rows) then
            var141_matA_rows
        else
            1)))))))))))) (( / ) (( * ) (var142_matA_cols) (var142_matA_cols)) (1024)))) in if (( < ) (( * ) (( * ) (var142_matA_cols) (var142_matA_cols)) (( + ) (8) (( + ) (0) (( + ) (1) (( + ) (1) (( + ) (9) (( + ) (9) (( + ) (1) (( + ) (1) (( + ) (14) (( + ) (0) (( * ) (80) (if ( < ) (1) (var141_matA_rows) then
            var141_matA_rows
        else
            1))))))))))))) (( + ) (( + ) (( * ) (( + ) (( * ) (var142_matA_cols) (var142_matA_cols)) (Array.length (var151_matA))) (2)) (150000000)) (( * ) (( + ) (8) (( + ) (0) (( + ) (1) (( + ) (1) (( + ) (30) (( + ) (30) (( + ) (1) (( + ) (1) (( + ) (14) (( + ) (0) (( * ) (70861) (if ( < ) (1) (var141_matA_rows) then
            var141_matA_rows
        else
            1)))))))))))) (( / ) (( * ) (var142_matA_cols) (var142_matA_cols)) (1024))))) then (Array.init (( * ) (var142_matA_cols) (var142_matA_cols)) (fun140_matrixATAWorker (var141_matA_rows) (var142_matA_cols) (var151_matA))) else (gpuhost_fun140_matrixATAWorker [|1; var141_matA_rows; var142_matA_cols; ( * ) (var142_matA_cols) (var142_matA_cols)|] [||] (var151_matA))
    in
    let var156_vecATAx  =
        let _ = printf "ocamlcost: %d\n" (( * ) (( * ) (var142_matA_cols) (var153_vecX_cols)) (( + ) (12) (( + ) (0) (( + ) (9) (( + ) (9) (( + ) (9) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (82) (if ( < ) (1) (var142_matA_cols) then
            var142_matA_cols
        else
            1))))))))))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (( + ) (( * ) (var142_matA_cols) (var153_vecX_cols)) (Array.length (var155_matATA))) (Array.length (var154_vecX))) (2)) (150000000)) (( * ) (( + ) (12) (( + ) (0) (( + ) (30) (( + ) (30) (( + ) (30) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (70863) (if ( < ) (1) (var142_matA_cols) then
            var142_matA_cols
        else
            1)))))))))) (( / ) (( * ) (var142_matA_cols) (var153_vecX_cols)) (1024)))) in if (( < ) (( * ) (( * ) (var142_matA_cols) (var153_vecX_cols)) (( + ) (12) (( + ) (0) (( + ) (9) (( + ) (9) (( + ) (9) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (82) (if ( < ) (1) (var142_matA_cols) then
            var142_matA_cols
        else
            1))))))))))) (( + ) (( + ) (( * ) (( + ) (( + ) (( * ) (var142_matA_cols) (var153_vecX_cols)) (Array.length (var155_matATA))) (Array.length (var154_vecX))) (2)) (150000000)) (( * ) (( + ) (12) (( + ) (0) (( + ) (30) (( + ) (30) (( + ) (30) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (70863) (if ( < ) (1) (var142_matA_cols) then
            var142_matA_cols
        else
            1)))))))))) (( / ) (( * ) (var142_matA_cols) (var153_vecX_cols)) (1024))))) then (Array.init (( * ) (var142_matA_cols) (var153_vecX_cols)) (fun121_matrixMuliWorker (var142_matA_cols) (var142_matA_cols) (var153_vecX_cols) (var155_matATA) (var154_vecX))) else (gpuhost_fun121_matrixMuliWorker [|1; var142_matA_cols; var142_matA_cols; var153_vecX_cols; ( * ) (var142_matA_cols) (var153_vecX_cols)|] [||] (var155_matATA) (var154_vecX))
    in
    ()