...
external gpuhost_fun128_matrixMuliWorker: int array -> float array -> int array -> int array -> int array = "gpuhost_fun128_matrixMuliWorker"
...
let main =
    ...
    in
    let var169_matAxB  =
        gpuhost_fun128_matrixMuliWorker [|64; var168_innerDim; var162_matA_rows; var166_matB_cols; ( * ) (var162_matA_rows) (var166_matB_cols)|] [||] (var164_matA) (var167_matB)
    in
