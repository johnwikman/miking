...
extern "C" {
	value gpuhost_fun140_matrixATAWorker(value packedInts, value packedFloats, value arg0);
	value gpuhost_fun121_matrixMuliWorker(value packedInts, value packedFloats, value arg0, value arg1);
}

__device__ int gpudevice_fun140_matrixATAWorker(int arg122_rows, int arg123_cols, value *arg124_a, int arg125_idx);
__device__ int gpudevice_fun132_dotprod(int arg139_outerDim, value *arg138_a, int arg137_innerDim, int arg133_acc, int arg134_p, int arg135_aT_offset, int arg136_a_offset);
...
__device__ int gpudevice_fun140_matrixATAWorker(int arg122_rows, int arg123_cols, value *arg124_a, int arg125_idx)
{
	int var126_innerDim = arg122_rows;
	int var127_outerDim = arg123_cols;
	int var128_row = gpu_divi(arg125_idx, arg123_cols);
	int var129_col = gpu_modi(arg125_idx, arg123_cols);
	int var130_aT_start_offset = var128_row;
	int var131_a_start_offset = var129_col;
	return gpudevice_fun132_dotprod(var127_outerDim, arg124_a, var126_innerDim, 0, 0, var130_aT_start_offset, var131_a_start_offset);
}

__device__ int gpudevice_fun132_dotprod(int arg139_outerDim, value *arg138_a, int arg137_innerDim, int arg133_acc, int arg134_p, int arg135_aT_offset, int arg136_a_offset)
{
	return (gpu_eqi(arg134_p, arg137_innerDim)) ? (arg133_acc) : (gpudevice_fun132_dotprod(arg139_outerDim, arg138_a, arg137_innerDim, gpu_addi(arg133_acc, gpu_muli(Int_val((arg138_a[arg135_aT_offset])), Int_val((arg138_a[arg136_a_offset])))), gpu_addi(arg134_p, 1), gpu_addi(arg135_aT_offset, arg139_outerDim), gpu_addi(arg136_a_offset, arg139_outerDim)));
}
...
__global__ void gpuglobal_fun140_matrixATAWorker(int cuda_arg0, int cuda_arg1, value *cuda_arg2, value *outarr, int n, int elemPerThread)
{
	int i;
	...
	for (i = start; i < end; ++i) {
		outarr[i] = Val_int(gpudevice_fun140_matrixATAWorker(cuda_arg0, cuda_arg1, cuda_arg2, i));
	}
}
...
value gpuhost_fun140_matrixATAWorker(value packedInts, value packedFloats, value arg0)
{
	...
	gpuglobal_fun140_matrixATAWorker<<<blockCount,threadsPerBlock>>>(Int_val(Field(packedInts, 1)), Int_val(Field(packedInts, 2)), cuda_arg0, cuda_outarr, n, elemPerThread);
