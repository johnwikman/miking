...
let main =
    ...
    in
    let var155_matATA  =
        fun14_seqInit (( * ) (var142_matA_cols) (var142_matA_cols)) (fun140_matrixATAWorker (var141_matA_rows) (var142_matA_cols) (var151_matA))
    in
    let var156_vecATAx  =
        fun14_seqInit (( * ) (var142_matA_cols) (var153_vecX_cols)) (fun121_matrixMuliWorker (var142_matA_cols) (var142_matA_cols) (var153_vecX_cols) (var155_matATA) (var154_vecX))
    in
    ()