...
let main =
    ...
    in
    let var155_matATA  =
        gpuhost_fun140_matrixATAWorker [|1; var141_matA_rows; var142_matA_cols; ( * ) (var142_matA_cols) (var142_matA_cols)|] [||] (var151_matA)
    in
    let var156_vecATAx  =
        gpuhost_fun121_matrixMuliWorker [|1; var142_matA_cols; var142_matA_cols; var153_vecX_cols; ( * ) (var142_matA_cols) (var153_vecX_cols)|] [||] (var155_matATA) (var154_vecX)
    in
    ()