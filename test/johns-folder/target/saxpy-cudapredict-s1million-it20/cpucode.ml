...
let main =
    ...
    in
    let var80_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var78_vecX)) (27)) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var78_vecX)) (Array.length (var79_vecY))) (Array.length (var78_vecX))) (2)) (150000000)) (( * ) (260) (( / ) (Array.length (var78_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var78_vecX)) (27)) (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var78_vecX)) (Array.length (var79_vecY))) (Array.length (var78_vecX))) (2)) (150000000)) (( * ) (260) (( / ) (Array.length (var78_vecX)) (1024))))) then (Array.mapi (fun72_saxpy (var77_scalarA) (var79_vecY)) (var78_vecX)) else (gpuhost_fun72_saxpy [|1; var77_scalarA|] [||] (var79_vecY) (var78_vecX))
    in
    let var81_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var78_vecX)) (27)) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var78_vecX)) (Array.length (var79_vecY))) (Array.length (var78_vecX))) (2)) (150000000)) (( * ) (260) (( / ) (Array.length (var78_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var78_vecX)) (27)) (( + ) (( + ) (( * ) (( + ) (( + ) (Array.length (var78_vecX)) (Array.length (var79_vecY))) (Array.length (var78_vecX))) (2)) (150000000)) (( * ) (260) (( / ) (Array.length (var78_vecX)) (1024))))) then (Array.mapi (fun72_saxpy (var77_scalarA) (var79_vecY)) (var78_vecX)) else (gpuhost_fun72_saxpy [|1; var77_scalarA|] [||] (var79_vecY) (var78_vecX))
    in
