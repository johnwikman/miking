...
external gpuhost_fun71_saxpy: int array -> float array -> int array -> int array = "gpuhost_fun71_saxpy"
...
let main =
    ...
    let fun66_printVec arg57_size arg58_vec =
        ...
        (fun s -> printf "%s" (String.of_seq (Array.to_seq s))) ([|'\n'|])
    in
    let fun71_saxpy arg68_a arg69_y arg70_xelem =
        ( + ) (( * ) (arg68_a) (arg70_xelem)) (arg69_y)
    in
    let fun73_vecXinitfun arg72_i =
        ( mod ) (( * ) (( * ) (arg72_i) (arg72_i)) (( - ) (500000000) (arg72_i))) (5073)
    in
    let var67_vecsize  =
        50000000
    in
    ...
    in
    let var75_vecX  =
        fun14_seqInit (var67_vecsize) (fun73_vecXinitfun)
    in
    let var76_scalarY  =
        19
    in
    let var77_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var75_vecX)) (21)) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var75_vecX)) (Array.length (var75_vecX))) (2)) (150000000)) (( * ) (59) (( / ) (Array.length (var75_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var75_vecX)) (21)) (( + ) (( + ) (( * ) (( + ) (Array.length (var75_vecX)) (Array.length (var75_vecX))) (2)) (150000000)) (( * ) (59) (( / ) (Array.length (var75_vecX)) (1024))))) then (Array.map (fun71_saxpy (var74_scalarA) (var76_scalarY)) (var75_vecX)) else (gpuhost_fun71_saxpy [|1; var74_scalarA; var76_scalarY|] [||] (var75_vecX))
    in
    let var78_vecS  =
        let _ = printf "ocamlcost: %d\n" (( * ) (Array.length (var75_vecX)) (21)) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (Array.length (var75_vecX)) (Array.length (var75_vecX))) (2)) (150000000)) (( * ) (59) (( / ) (Array.length (var75_vecX)) (1024)))) in if (( < ) (( * ) (Array.length (var75_vecX)) (21)) (( + ) (( + ) (( * ) (( + ) (Array.length (var75_vecX)) (Array.length (var75_vecX))) (2)) (150000000)) (( * ) (59) (( / ) (Array.length (var75_vecX)) (1024))))) then (Array.map (fun71_saxpy (var74_scalarA) (var76_scalarY)) (var75_vecX)) else (gpuhost_fun71_saxpy [|1; var74_scalarA; var76_scalarY|] [||] (var75_vecX))
    in
