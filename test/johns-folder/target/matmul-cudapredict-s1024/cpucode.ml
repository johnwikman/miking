...
let main =
    ...
    in
    let fun157_matAinitfun arg155_row arg156_col =
        ( + ) (( * ) (arg155_row) (arg155_row)) (arg156_col)
    in
    let fun160_matBinitfun arg158_row arg159_col =
        ( mod ) (( / ) (( * ) (( + ) (arg158_row) (19)) (17)) (( + ) (arg159_col) (13))) (( + ) (arg158_row) (11))
    in
    let fun163_matAinitfun_v2 arg161_row arg162_col =
        ( - ) (( mod ) (( + ) (( * ) (arg161_row) (arg161_row)) (arg162_col)) (3)) (1)
    in
    let fun166_matBinitfun_v2 arg164_row arg165_col =
        ( mod ) (( / ) (( * ) (( + ) (arg164_row) (19)) (17)) (( + ) (arg165_col) (13))) (2)
    in
    ...
    in
    let var167_matA  =
        fun86_matrixIniti (var151_matA_rows) (var152_matA_cols) (fun163_matAinitfun_v2)
    in
    let var168_matB  =
        fun86_matrixIniti (var153_matB_rows) (var154_matB_cols) (fun166_matBinitfun_v2)
    in
    let var169_innerDim  =
        var152_matA_cols
    in
    let var170_matAxB  =
        let _ = printf "ocamlcost: %d\n" (( * ) (( * ) (var151_matA_rows) (var154_matB_cols)) (( + ) (12) (( + ) (0) (( + ) (9) (( + ) (9) (( + ) (9) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (82) (if ( < ) (1) (var169_innerDim) then
            var169_innerDim
        else
            1))))))))))) in let _ = printf "cudacost: %d\n" (( + ) (( + ) (( * ) (( + ) (( + ) (( * ) (var151_matA_rows) (var154_matB_cols)) (Array.length (var167_matA))) (Array.length (var168_matB))) (2)) (150000000)) (( * ) (( + ) (12) (( + ) (0) (( + ) (30) (( + ) (30) (( + ) (30) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (70863) (if ( < ) (1) (var169_innerDim) then
            var169_innerDim
        else
            1)))))))))) (( / ) (( * ) (var151_matA_rows) (var154_matB_cols)) (1024)))) in if (( < ) (( * ) (( * ) (var151_matA_rows) (var154_matB_cols)) (( + ) (12) (( + ) (0) (( + ) (9) (( + ) (9) (( + ) (9) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (82) (if ( < ) (1) (var169_innerDim) then
            var169_innerDim
        else
            1))))))))))) (( + ) (( + ) (( * ) (( + ) (( + ) (( * ) (var151_matA_rows) (var154_matB_cols)) (Array.length (var167_matA))) (Array.length (var168_matB))) (2)) (150000000)) (( * ) (( + ) (12) (( + ) (0) (( + ) (30) (( + ) (30) (( + ) (30) (( + ) (1) (( + ) (16) (( + ) (0) (( * ) (70863) (if ( < ) (1) (var169_innerDim) then
            var169_innerDim
        else
            1)))))))))) (( / ) (( * ) (var151_matA_rows) (var154_matB_cols)) (1024))))) then (Array.init (( * ) (var151_matA_rows) (var154_matB_cols)) (fun131_matrixMuliWorker (var169_innerDim) (var151_matA_rows) (var154_matB_cols) (var167_matA) (var168_matB))) else (gpuhost_fun131_matrixMuliWorker [|1; var169_innerDim; var151_matA_rows; var154_matB_cols; ( * ) (var151_matA_rows) (var154_matB_cols)|] [||] (var167_matA) (var168_matB))
    in
    ()